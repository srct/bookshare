...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Listing.ISBN'
        db.alter_column(u'website_listing', 'ISBN', self.gf('django.db.models.fields.CharField')(max_length=20))

    def backwards(self, orm):

        # Changing field 'Listing.ISBN'
        db.alter_column(u'website_listing', 'ISBN', self.gf('django.db.models.fields.CharField')(max_length=15))
    ...
    models = {
        ...
        u'website.listing': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 11, 0, 0)'}),
