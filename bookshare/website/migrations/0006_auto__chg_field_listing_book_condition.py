...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Listing.book_condition'
        db.alter_column(u'website_listing', 'book_condition', self.gf('django.db.models.fields.IntegerField')())

    def backwards(self, orm):

        # Changing field 'Listing.book_condition'
        db.alter_column(u'website_listing', 'book_condition', self.gf('django.db.models.fields.TextField')())
    ...
    models = {
        ...
        u'website.listing': {
            ...
            'book_condition': ('django.db.models.fields.IntegerField', [], {'default': '3'}),
