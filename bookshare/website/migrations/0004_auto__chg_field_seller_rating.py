...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Seller.rating'
        db.alter_column(u'website_seller', 'rating', self.gf('django.db.models.fields.IntegerField')())

    def backwards(self, orm):

        # Changing field 'Seller.rating'
        db.alter_column(u'website_seller', 'rating', self.gf('django.db.models.fields.IntegerField')(null=True))
