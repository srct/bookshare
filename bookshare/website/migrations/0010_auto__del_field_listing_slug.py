...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Listing.slug'
        db.delete_column(u'website_listing', 'slug')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Listing.slug'
        raise RuntimeError("Cannot reverse this migration. 'Listing.slug' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Listing.slug'
        db.add_column(u'website_listing', 'slug',
    ...
    models = {
        ...
        u'website.listing': {
            ...
            'Meta': {'unique_together': "(('ISBN', 'seller'),)", 'object_name': 'Listing'},
