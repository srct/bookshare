...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Listing.finalPrice'
        db.alter_column(u'website_listing', 'finalPrice', self.gf('django.db.models.fields.IntegerField')())

    def backwards(self, orm):

        # Changing field 'Listing.finalPrice'
        db.alter_column(u'website_listing', 'finalPrice', self.gf('django.db.models.fields.IntegerField')(null=True))
    ...
    models = {
        ...
        u'website.listing': {
            ...
            'finalPrice': ('django.db.models.fields.IntegerField', [], {'default': '0', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
