...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Listing', fields ['ISBN', 'seller']
        db.delete_unique(u'website_listing', ['ISBN', 'seller_id'])


    def backwards(self, orm):
        # Adding unique constraint on 'Listing', fields ['ISBN', 'seller']
        db.create_unique(u'website_listing', ['ISBN', 'seller_id'])
    ...
    models = {
        ...
        u'website.listing': {
            ...
            'Meta': {'ordering': "['-sold', 'title']", 'object_name': 'Listing'},
